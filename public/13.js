...
/***/ "./resources/js/src/containers/Backend/User/Issues/index.js":
/*!******************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Issues/index.js ***!
  \******************************************************************/
/*! exports provided: default */
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          issid = _this$props$content$c3.issid,
          platform = _this$props$content$c3.platform,
          ...
          issues = _this$props$backend$i.issues,
      ...
      var data = issues.map(function (issue) {
        return Object(_shared_utility__WEBPACK_IMPORTED_MODULE_15__["updateObject"])(issue, {
          action: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
            className: "text-center"
          }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_2__["Link"], {
            to: "/user/issues/".concat(issue.id),
            className: "mr-2"
            ...
            to: "/user/issues/".concat(issue.id, "/edit"),
            className: "mx-1"
          }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_4__["FontAwesomeIcon"], {
            ...
            deleteAction: function deleteAction() {
              return _this.props["delete"](issue.id);
            }
          }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_4__["FontAwesomeIcon"], {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_14__["getIssues"](page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_14__["deleteIssues"](id));
    },
    reset: function reset() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_14__["resetIssues"]());
    }
  };
};
